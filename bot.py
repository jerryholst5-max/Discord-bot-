...
async def update_teamliste(guild: discord.Guild):
    ...
    for role_entry in roles:
        ...
        # ── Rollenname FARBIG: role.mention im field name ──
        # Discord rendert role mentions (<@&ID>) im Field-Name farbig
        # mit der echten Rollenfarbe (z.B. Gold für Owner, Rot für Admin)
        field_name = f"@ | {role.mention} ({len(members)})"

        # Nur die Member-Mentions als Field-Value
        field_value = member_str
