...
async def send_unified_log(guild: discord.Guild, category: str, embed: discord.Embed):
    """Sendet einen Log-Eintrag wenn die Kategorie aktiviert ist."""
...
async def on_member_ban(guild, user):
    ...
    embed.add_field(name="Moderator", value=str(executor) if executor else "Unbekannt", inline=True)
...
async def on_member_remove(member):
    ...
    if executor:
        ...
        log_embed.add_field(name="Moderator", value=str(executor), inline=True)
