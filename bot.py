...
class TicketCloseView(discord.ui.View):
    ...
    async def release_ticket(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        # Notification-Nachricht zurücksetzen (Annehmen-Button wieder aktiv) und erneut pingen
        try:
                ...
                if notif_ch:
                    ...
                    if notif_msg_id:
                        try:
                            ...
                            await old_msg.edit(view=new_notif_view)
                    ...
                    if not notif_msg_id:
                        ...
                        if ping_text:
                            ping_msg = await notif_ch.send(content=f"{ping_text} 🔓 Ticket wurde freigegeben, bitte erneut annehmen!")
        except Exception as e:
