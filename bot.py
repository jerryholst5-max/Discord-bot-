...
def _generate_captcha_image() -> tuple[str, discord.File]:
    ...
    for _ in range(6):
        ...
        draw.line([start, ende], fill=(random.randint(60, 100), random.randint(60, 100), random.randint(60, 100)), width=2)

    try:
        schrift = ImageFont.truetype("/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf", 42)
    except Exception:
