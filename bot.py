...
class VoiceSupportView(discord.ui.View):
    ...
    async def accept(self, interaction: discord.Interaction, button: discord.ui.Button):
        if not has_support_role(interaction, self.support_role_id):
            await interaction.response.send_message("❌ Du hast keine Berechtigung Support anzunehmen!", ephemeral=True)
            return
        guild = interaction.guild
        ...
        # Prüfen ob der Support selbst in einem Voice-Kanal der Kategorie ist
        ...
        # User in den Kanal des Supports ziehen
        try:
    ...
    async def decline(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        await interaction.response.edit_message(
            embed=liquid_glass_embed(
                "❌ Support abgelehnt",
                f"Der Support für {member.mention if member else 'Unbekannt'} wurde abgelehnt.",
...
class VoiceSupportCloseView(discord.ui.View):
    ...
    @discord.ui.button(label="🔒 Support schließen", style=discord.ButtonStyle.danger)
