...
def _generate_captcha_image() -> tuple[str, discord.File]:
    ...
    for _ in range(12):
        ...
        draw.line([start, ende], fill=(random.randint(60, 100), random.randint(60, 100), random.randint(60, 100)), width=5)
    ...
    for _ in range(14):
        start = (random.randint(0, breite), random.randint(0, hoehe))
        ende = (random.randint(0, breite), random.randint(0, hoehe))
        draw.line([start, ende], fill=(random.randint(90, 150), random.randint(90, 150), random.randint(90, 150)), width=5)
